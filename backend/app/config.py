...
EMPTY_THRESHOLD = float(os.getenv("OMR_EMPTY_THRESHOLD", "0.12"))
MARK_THRESHOLD = float(os.getenv("OMR_MARK_THRESHOLD", "0.24"))
UNCERTAIN_MARGIN = float(os.getenv("OMR_UNCERTAIN_MARGIN", "0.08"))
DOUBLE_MARK_THRESHOLD = float(os.getenv("OMR_DOUBLE_MARK_THRESHOLD", "0.28"))
